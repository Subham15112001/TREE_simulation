...
function reset() {
  d3.selectAll('svg').remove();//reseting image
}

function treeAndArray() {
  reset();
  let inputText = document.getElementById("array-input")//taking input
  
  //DOM manipulation to put text 
  ...
  if (inputText.value !== '') {//check not empty
